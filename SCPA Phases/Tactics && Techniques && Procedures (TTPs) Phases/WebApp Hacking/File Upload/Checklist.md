...
Search Tag(s): #checklist #webapp #file-upload
...
- [ ] Run an [[Tactics && Techniques && Procedures (TTPs) Phases/WebApp Hacking/File Upload/Scanners/Nmap|NSE script]] to probe for file upload vulnerabilities on the webservers with `-iL ip_targets.txt` flag.
