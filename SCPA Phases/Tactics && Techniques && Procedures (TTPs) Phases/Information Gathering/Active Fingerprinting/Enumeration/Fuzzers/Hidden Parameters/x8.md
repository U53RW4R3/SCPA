...
`$ cargo install x8 && sudo cp ~/.cargo/bin/x8 /usr/local/bin/`
...
cd x8/ && rustup default stable && cargo b -r &&
...
FLAGS:
    ...
    -h, --help                         Prints help information
        ...
        --invert                       By default, parameters are sent within the body only in case
                                       POST,PUT,PATCH,DELETE methods are used.
