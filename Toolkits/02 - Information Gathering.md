...
* Network & Port Scanners
    ...
    9. [TXPortMap](https://github.com/4dogs-cn/TXPortMap)
    10. [scaninfo](https://github.com/redtoolskobe/scaninfo)
    11. [EHole](https://github.com/EdgeSecurityTeam/EHole)
    12. [NimScan](https://github.com/elddy/NimScan)
...
* SMB Analysis
    ...
    5. [Pywinrm](https://github.com/diyan/pywinrm)
    6. [PsMapExec](https://github.com/The-Viper-One/PsMapExec)
    7. [SharpMapExec](https://github.com/cube0x0/SharpMapExec) (C# version of CrackMapExec)
    8. [SharpSecDump](https://github.com/G0ldenGunSec/SharpSecDump) (C# version of secretsdump.py)
    9. [SharpExec](https://github.com/anthemtotheego/SharpExec) (C# version of impacket for lateral movement)
    10. [adalanche](https://github.com/lkarlslund/adalanche) (Inspired by Bloodhound)
    11. [ntlmscan](https://github.com/nyxgeek/ntlmscan)

* SMTP Analysis
    1. [MagicSpoofing](https://github.com/magichk/magicspoofing)
...
- [Automater](http://www.tekdefense.com/automater/) && [Gitlab Repo](https://gitlab.com/kalilinux/packages/automater)

- [ATSCAN](https://github.com/AlisamTechnology/ATSCAN)
- [IVRE](https://ivre.rocks) && [Github Repo](https://github.com/cea-sec/ivre)

- [ReconPi](https://github.com/x1mdev/ReconPi)
- [RunasCs](https://github.com/antonioCoco/RunasCs)
- [Shodanfy](https://github.com/dwisiswant0/Shodanfy.py)
- [iPwn (Just a list of tools with improvements to the lastest version)](https://github.com/altjx/ipwn/)
- [Pythonizing Nmap](https://github.com/gh0x0st/pythonizing_nmap)
