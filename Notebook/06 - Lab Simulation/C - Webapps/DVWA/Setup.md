...
This will grant the `dvwa@localhost` DB user with least privileges. But skip this step and move on for [[06 - Lab Simulation/C - Webapps/DVWA/Setup#^14f9b2|granting all privileges]] to have the full experience of SQLi.
