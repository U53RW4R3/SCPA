...
When executing through [[Command Prompt|command prompt]].

```
C:\> conhost.exe --headless cmd.exe /c <commands>
```

When executing through [[06 - Tactics & Techniques & Procedures (TTPs) Phases/C - Initial Access/0x01 - Weaponization/0xC - Client-Side Attacks/Delivery Methods/Command and Scripting Interpreter/Desktop/Windows/Code Execution/PowerShell|PowerShell]].
