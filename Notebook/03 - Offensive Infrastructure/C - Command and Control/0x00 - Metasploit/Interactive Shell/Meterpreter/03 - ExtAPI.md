...
```
meterpreter > adsi_nested_group_user_enum <domain_name> "CN=Domain Admins,CN=Users,DC=demo,DC=mwr"

meterpreter > adsi_nested_group_user_enum [<subdomain>.]<domain>.<tld> "CN=Domain Admins,CN=Users,DC=demo,DC=mwr"
```

```
meterpreter > adsi_domain_query <domain_name> <ldap_query>
