...
msf auxiliary(scanner/imap/imap_version) > run -j rhosts=<IP>
```
...
- [[07 - Tactics & Techniques & Procedures Phases/B - Vulnerability Assessment/0x03 - Network Ports/Mail Server/IMAP|Vulnerability Assessment: IMAP]]

### Hacktricks

- [Hacktricks: Pentesting IMAP](https://hacktricks.wiki/en/network-services-pentesting/pentesting-imap.html)