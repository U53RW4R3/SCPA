...
- [Hacktricks: Pentesting DNS](https://hacktricks.wiki/en/network-services-pentesting/pentesting-dns.html)

### Sidxparab

- [Sidxparab: Vertical Enumeration](https://sidxparab.gitio/subdomain-enumeration-guide/types/vertical-enumeration)