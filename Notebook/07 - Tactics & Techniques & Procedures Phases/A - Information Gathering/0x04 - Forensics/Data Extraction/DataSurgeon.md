...
```
$ curl -s https://raw.githubusercontent.com/Drew-Alleman/DataSurgeon/main/install/install.sh | bash
...
```
$ ds --directory /path/to/directory/
```

Collect hashed credentials.

```
$ ds -H --directory /path/to/directory/
```

```
$ ds -Dl --directory /path/to/directory/

$ ds -CT --directory /path/to/directory/
```
