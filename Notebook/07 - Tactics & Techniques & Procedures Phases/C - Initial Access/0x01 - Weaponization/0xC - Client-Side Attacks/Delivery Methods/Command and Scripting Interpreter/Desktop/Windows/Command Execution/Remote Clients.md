...
You can include make a decoy using [[07 - Tactics & Techniques & Procedures Phases/F - Post Exploitation/0x09 - Miscellaneous/Troll/Windows/Manual/Living off the Land|messagebox]].
...
Instead of dropping malware instead we'll use [[07 - Tactics & Techniques & Procedures Phases/F - Post Exploitation/0x05 - Pivot/Linux/SOCKS Proxy/Proxychains|proxychains]] or [[02 - Configure Proxies#^0a4669|privoxy]] with the SSH server (the attacker's server) as the command and control which is legitimate, safer, and more familiar performing things remotely. This is considered as a non-malware payload.
...
- [[07 - Tactics & Techniques & Procedures Phases/F - Post Exploitation/0x04 - File Transfer and Data Exfiltration/Cross Platform/Network Ports/SSH/Usage|File Transfer: SCP]]
