...
Refer to **Client-Side Attacks** subsection under [[07 - Tactics & Techniques & Procedures (TTPs) Phases/C - Initial Access/06 - Client-Side Attacks/Authentication Relay/Metasploit|Metasploit]].
